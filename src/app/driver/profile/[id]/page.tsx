...
import { getDriverDetailsByUserIdRequest } from "@/services/api/driver-details/driver-details.api";

type Props = {
  params: Promise<{ id: string }>;
};

const PreviewDriverProfile: FC<Props> = (props) => {
  const [profile, setProfile] = useState<DriverDetailsInterface | null>(null);
...
export default PreviewDriverProfile;
